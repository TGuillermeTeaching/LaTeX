...
\begin{itemize}
\item Download and install \href{https://packagecontrol.io/}{\textbf{package control}}. % Modify! And copy paste the relevant part in Sublime
...
\item Type in \texttt{LaTeXing} %Or \texttt{LaTeX tools?}
